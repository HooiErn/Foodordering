...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card card-body bg-warning text-white mb-3">
            <h5 class="card-title">This Month Order</h5>
            <h1>{{$thisMonthOrder}}</h1>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card card-body bg-danger text-white mb-3">
            <h5 class="card-title">This Year Order</h5>
            <h1>{{$thisYearOrder}}</h1>
        </div>
    </div>
</div>

<h4 class="text-dark twxt-uppercase m-2">Earnings</h4>
<div class="row">
        ...
        <div class="card border-left-dark shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-money-bill-wave fa-2x text-gray-300"></i> <!-- Replace with your desired icon -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-money-bill-alt fa-2x text-gray-300"></i> <!-- Replace with your desired icon -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-md-4 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <h5 class="card-title">Touch n Go</h5>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">RM {{ $data->where('waiter', '!=', null)->where('payment_method', 2)->sum('amount') }}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-credit-card fa-2x text-gray-300"></i> <!-- Replace with your desired icon -->
                    </div>
                </div>
            </div>
        </div>
...
<h4 class="text-dark twxt-uppercase m-2">Chart</h4>
<div class="row">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Touch 'n Go
                    </span>
                </div>
            </div>
        </div>
